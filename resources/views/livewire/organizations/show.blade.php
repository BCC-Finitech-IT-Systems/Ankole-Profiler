    ...
    <x-slot name="header">
        <div class="flex items-center justify-between w-full gap-4">
            ...
            <div class="flex items-center gap-2">
                ...
                {{-- "Edit Organization" removed: no organizations.edit route exists, so the
                     button could only ever render permanently disabled. Restore it here when
                     the edit flow is built. --}}
            </div>
        </div>
    </x-slot>
