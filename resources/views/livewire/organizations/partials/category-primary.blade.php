{{-- Primary School-Specific Details --}}
<div class="space-y-6">
    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div class="form-control">
            <label class="label">
                <span class="label-text font-medium">Headteacher Name</span>
            </label>
        ...
        <div class="form-control">
            ...
            <input type="number" wire:model="categoryDetails.current_enrollment" class="input input-bordered"
                   placeholder="Current number of pupils" min="0">
        ...
        <div class="form-control">
            <label class="label">
                <span class="label-text font-medium">Classes / Streams</span>
            </label>
            <input type="text" wire:model="categoryDetails.classes" class="input input-bordered"
                   placeholder="e.g. P1–P7, 2 streams each">
            @error('categoryDetails.classes') <span class="text-red-600 text-sm">{{ $message }}</span> @enderror
        </div>
    </div>
    ...
    <div class="form-control">
        ...
        <textarea wire:model="categoryDetails.facilities" class="textarea textarea-bordered h-20"
                  placeholder="e.g. library, computer lab, sports field, music, drama, school garden..."></textarea>
